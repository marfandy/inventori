			...
			<div class="card-body">
				<div class="col-12">
					<div class="col-lg-6 col-xlg-6 m-b-30">
						<a href="<?php echo base_url()?>laporan/preview_kondisi" target="_blank" class="btn btn-outline-secondary waves-effect waves-light" type="button"><span class="btn-label"><i class="fa fa-eye"></i></span> Preview</a>
						<a href="<?php echo base_url()?>laporan/excel_kondisi" class="btn btn-outline-secondary waves-effect waves-light" type="button"><span class="btn-label"><i class="fa fa-file-excel-o"></i> </span> Export Excel</a>
					</div>
