...
<body>
	<p style="font-size: 10px;">PT. ANGKASAPURA I (PERSERO) <br>CABANG BANDARA INTERNASIONAL SULTAN HASANUDDIN MAKASSAR</P>
		<div style="text-align: center;margin-top: 10px;">
			...
			<p><b>LAPORAN BULANAN<br>DAFTAR DAN KONDISI	
				DATA PERALATAN AIRPORT TECHNOLOGY, NETWORK OPERATION & SUPPORT SECTION<br clear="left">
				POSISI BULAN <?php echo strtoupper(date('F Y'));?></b></p>
